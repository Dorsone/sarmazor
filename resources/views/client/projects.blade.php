                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div
                                            ...
                                            <div class="project-item architecture building construction">
                                                <div class="inner">
                                                    ...
                                                    <div class="text-wrap">
                                                        <h5 class="heading"><a href="#">CAVAL RIDGE MINE PROJECT </a>
                                                        </h5>
                                                        <div class="elm-meta">
                                            ...
                                            <div class="project-item villa architecture building construction">
                                                <div class="inner">
                                                    ...
                                                    <div class="text-wrap">
                                                        <h5 class="heading"><a href="#">GRAM HOTEL MAMZANA, MEWYORK</a>
                                                        </h5>
                                                        <div class="elm-meta">
                                                            <span><a href="#">Green House</a></span>
                                                            <span><a href="#">Villa</a></span>
                                        ...
                                        <div class="button-wrap has-icon icon-left size-14 pf21 text-center">
                                            <a href="#" class="themesflat-button bg-accent pd32"><span>LOAD MORE <span
                                                        class="icon"><i
                                                            class="ion-load-c"></i></span></span></a>
                                        </div>
