            ...
            <div class="col span_1_of_3">
                <div class="widget widget_text">
                    <div class="textwidget">
                        <p>
                            <img src="{{ asset('assets/img/logo-white@2x.png') }}" alt="Image" width="170"
                                 height="34">
                        </p>

                        <p class="margin-bottom-15">We have over 15 years of experien able to help you 24 hours
                            a day.</p>
                ...
                <div class="widget widget_lastest">
                    ...
                    <ul class="lastest-posts data-effect clearfix">
                        <li class="clearfix">
                            ...
                            <div class="text">
                                <h3><a href="page-blog-single.html">SMART BUILDING WITH CONCRETE SUSTAINABLE</a>
                                </h3>
                        ...
                        <li class="clearfix">
                            ...
                            <div class="text">
                                <h3><a href="page-blog-single.html">HI-TECH WOODEN HOUSE BUILT WITHOUT GLUE</a>
                                </h3>
            ...
            <div class="col span_1_of_3">
                ...
                <div class="widget widget_tags">
                    ...
                    <div class="tags-list">
                        ...
                        <a href="javascript:void(0)">Smart House</a>
                        <a href="javascript:void(0)">Costruction</a>
                        <a href="javascript:void(0)">Villa</a>
                        <a href="javascript:void(0)">Residential</a>
                        <a href="javascript:void(0)">Interior</a>
                        <a href="javascript:void(0)">Resort</a>
                ...
                <div class="widget widget_instagram">
                    ...
                    <div class="instagram-wrap data-effect clearfix col3 g10">
                        <div class="instagram_badge_image has-effect-icon">
                            <a href="javascript:void(0)" target="_blank" class="data-effect-item">
                                        <span class="item"><img
                                                src="{{ asset('assets/img/instagram/instagram-1-83x83.jpg') }}"
                                                alt="Image"></span>
                                <div class="overlay-effect bg-color-2"></div>
                                <div class="elm-link">
                        ...
                        <div class="instagram_badge_image has-effect-icon">
                            <a href="javascript:void(0)" target="_blank" class="data-effect-item">
                                        <span class="item"><img
                                                src="{{ asset('assets/img/instagram/instagram-2-83x83.jpg') }}"
                                                alt="Image"></span>
                                <div class="overlay-effect bg-color-2"></div>
                                <div class="elm-link">
                                    <span class="icon-3"></span>
                        ...
                        <div class="instagram_badge_image has-effect-icon">
                            <a href="javascript:void(0)" target="_blank" class="data-effect-item">
                                        <span class="item"><img
                                                src="{{ asset('assets/img/instagram/instagram-3-83x83.jpg') }}"
                                                alt="Image"></span>
                                <div class="overlay-effect bg-color-2"></div>
                                <div class="elm-link">
                                    <span class="icon-3"></span>
                        ...
                        <div class="instagram_badge_image has-effect-icon">
                            <a href="javascript:void(0)" target="_blank" class="data-effect-item">
                                        <span class="item"><img
                                                src="{{ asset('assets/img/instagram/instagram-4-83x83.jpg') }}"
                                                alt="Image"></span>
                                <div class="overlay-effect bg-color-2"></div>
                                <div class="elm-link">
                                    <span class="icon-3"></span>
                        ...
                        <div class="instagram_badge_image has-effect-icon">
                            <a href="javascript:void(0)" target="_blank" class="data-effect-item">
                                        <span class="item"><img
                                                src="{{ asset('assets/img/instagram/instagram-5-83x83.jpg') }}"
                                                alt="Image"></span>
                                <div class="overlay-effect bg-color-2"></div>
                                <div class="elm-link">
                                    <span class="icon-3"></span>
                        ...
                        <div class="instagram_badge_image has-effect-icon">
                            <a href="javascript:void(0)" target="_blank" class="data-effect-item">
                                        <span class="item"><img
                                                src="{{ asset('assets/img/instagram/instagram-6-83x83.jpg') }}"
                                                alt="Image"></span>
                                <div class="overlay-effect bg-color-2"></div>
                                <div class="elm-link">
                                    <span class="icon-3"></span>
